# Diseño de Software - Desarrollo de un Sistema Gestor de Actividades Personales (GAP)
...
## Descripción 💻
**Planify** es un **Sistema Gestor de Actividades Personales (GAP)**  diseñado para ayudar a los usuarios a **organizar sus tareas, eventos y metas** , integrando además el **registro del estado emocional**  y **sugerencias de autocuidado**.
